...
let leadsDB: Lead[] = [
  {
    ...
    notes: 'Very interested in retention metrics',
  },
  {
    id: 'lead-2',
    userId: 'user-1',
    ...
    notes: 'Requested more information on business model',
  },
  {
    id: 'lead-3',
    userId: 'user-1',
    ...
    notes: 'Potential investor for seed round',
  },
  {
    id: 'lead-4',
    userId: 'user-1',
    ...
    notes: 'In due diligence process, very advanced',
  },
  {
    id: 'lead-5',
    userId: 'user-1',
    ...
    notes: 'First conversation very positive',
  },
  {
    id: 'lead-6',
    userId: 'user-1',
    ...
    notes: 'Investor confirmed, awaiting legal close',
  },
];
...
const getFirebaseService = async () => {
  ...
  try {
    const mod = await import('./leadService.firebase');
    firebaseService = mod.leadServiceFirebase;
